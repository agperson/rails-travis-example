[![Build Status](https://travis-ci.org/agperson/rails-travis-example.svg?branch=master)](https://travis-ci.org/agperson/rails-travis-example) [![Code Climate](https://codeclimate.com/github/agperson/rails-travis-example.png)](https://codeclimate.com/github/secure-pipeline/rails-travis-example)
